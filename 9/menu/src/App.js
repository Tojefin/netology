...
function Menu() {
  return (
    <nav className="menu">
      <NavLink className={({isActive}) => "menu__item " + (isActive ? "menu__item-active" : "")} to="" end>Главная</NavLink>
      <NavLink className={({isActive}) => "menu__item " + (isActive ? "menu__item-active" : "")} to="drift">Дрифт-такси</NavLink>
      <NavLink className={({isActive}) => "menu__item " + (isActive ? "menu__item-active" : "")} to="timeattack">Time Attack</NavLink>
